...
trait BaseApiRepositoryTrait
{
    ...
    {
        return $this ->resourceQuery($this ->getModel() ->where($attribute, '=', $id));
    }
    ...
    {
        return $this ->collectionQuery($this ->getModel() ->whereLike($this ->searchFields(), $searchTerm));
    }
    ...
    {
        return $this ->collectionQuery($this ->getModel() ->whereLike($this ->searchFields(), $searchTerm), true);
    }
